                                                ...
                                                <div class="gdlr-core-pbf-element">
                                                    <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-center-align gdlr-core-title-item-caption-top gdlr-core-item-pdlr" style="padding-bottom: 10px ;">
                                                        <div class="gdlr-core-title-item-title-wrap ">
                                                            <h3 class="gdlr-core-title-item-title gdlr-core-skin-title " style="font-size: 32px ;font-weight: 600 ;letter-spacing: 0px ;text-transform: none ;color: #18181f ;">Notícias
                                                                ...
                                                                <li class="gdlr-core-item-mglr">
                                                                    <div class="gdlr-core-product-grid-3 gdlr-core-item-mgb  gdlr-core-button-style-border gdlr-core-move-up-with-shadow gdlr-core-outer-frame-element">
                                                                        <div class="gdlr-core-product-thumbnail gdlr-core-media-image  gdlr-core-zoom-on-hover">
                                                                            <a href="{{url("/noticias/".base64_encode($n->codigo))}}"><img src="{{$n->image}}" alt="" width="600" height="647" title=""></a>
                                                                        </div>
                                                                        <div class="gdlr-core-product-grid-content gdlr-core-skin-e-background">

                                                                            <h3 class="gdlr-core-product-title gdlr-core-skin-title" style="font-size: 15px ;font-weight: 500 ;letter-spacing: 0px ;"><a href="{{url("/noticias/".base64_encode($n->codigo))}}">{{$n->titulo}}</a></h3>
                                                                            <a href="{{url("/noticias/".base64_encode($n->codigo))}}" data-quantity="1" class="product_type_simple add_to_cart_button ajax_add_to_cart gdlr-core-product-add-to-cart" rel="nofollow">
