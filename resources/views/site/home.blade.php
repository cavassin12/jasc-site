            ...
            <div class="bigslam-page-wrapper" id="bigslam-page-wrapper">
                <div class="gdlr-core-page-builder-body">
                    ...
                    <div class="gdlr-core-pbf-wrapper " style="margin: -180px 0px 0px 0px;padding: 20px 0px 0px 0px;" data-skin="Hp3 Score" id="gdlr-core-wrapper-1">
                        ...
                        <div class="gdlr-core-pbf-wrapper-conteb  nt gdlr-core-js ">
                            <div class="gdlr-core-pbf-wrapper-container clearfix gdlr-core-container">
                                    ...
                                    <div class="gdlr-core-pbf-column gdlr-core-column-60 gdlr-core-column-first" id="gdlr-core-column-27732" style="z-index: 9 ;">
                                        <div class="gdlr-core-pbf-column-content-margin gdlr-core-js " style="padding: 50px 0px 60px 0px;">
                                            <div class="gdlr-core-pbf-background-wrap" style="background-color: #0a0a0a ;border-radius: 5px 5px 5px 5px;-moz-border-radius: 5px 5px 5px 5px;-webkit-border-radius: 5px 5px 5px 5px;">
                                                <div class="gdlr-core-pbf-background gdlr-core-parallax gdlr-core-js" style="background-image: url(upload/.jpg) ;opacity: 0.8 ;background-size: cover ;background-position: center ;" data-parallax-speed="0"></div>
                                            </div>
                                                        ...
                                                        <ul class="slides">
                                                            ...
                                                            <div class="gdlr-core-item-list gdlr-core-blog-full  gdlr-core-item-pdlr gdlr-core-style-left">
                                                                ...
                                                                <div class="gdlr-core-blog-date-wrapper gdlr-core-skin-divider">
                                                                    <div class="gdlr-core-blog-date-day gdlr-core-skin-caption">{{substr($n->dt_record, 8,2)}}</div>
                                                                    <div class="gdlr-core-blog-date-month gdlr-core-skin-caption">{{App\Models\Sistema::intToStrMes(intval(substr($n->dt_record, 5, 2)))}}</div>
                                                                    <div class="gdlr-core-blog-date-year gdlr-core-skin-caption">{{substr($n->dt_record, 0,4)}}</div>
                                                                </div>
                                                                <div class="gdlr-core-blog-full-content">
                                                                    <h3 class="gdlr-core-blog-title gdlr-core-skin-title" style="font-size: 30px ;font-weight: 800 ;letter-spacing: 0px ;">
                                                                        <a href="{{url('noticias/'.base64_encode($n->codigo))}}">{{$n->titulo}}</a>
                                                                    </h3>
                                    ...
                                    <div class="gdlr-core-pbf-column-content-margin gdlr-core-js " style="padding: 0px 0px 60px 0px;">
                                        ...
                                        <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js ">
                                            <div class="gdlr-core-pbf-element">
                                                <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-center-align gdlr-core-title-item-caption-top gdlr-core-item-pdlr" style="padding-bottom: 10px ;">
                                                    <div class="gdlr-core-title-item-title-wrap ">
                                                        <h3 class="gdlr-core-title-item-title gdlr-core-skin-title " style="font-size: 32px ;font-weight: 600 ;letter-spacing: 0px ;text-transform: none ;color: #18181f ;">Galeria
                                                            <span class="gdlr-core-title-item-title-divider gdlr-core-skin-divider"></span>
                                                        </h3>
                                                    </div>
                                                </div>
                                                                ...
                                                                <div class="gdlr-core-product-grid-3 gdlr-core-item-mgb  gdlr-core-button-style-border gdlr-core-move-up-with-shadow gdlr-core-outer-frame-element">
                                                                    ...
                                                                    <div class="gdlr-core-product-grid-content gdlr-core-skin-e-background">
                                                                        ...
                                                                        <h3 class="gdlr-core-product-title gdlr-core-skin-title" style="font-size: 16px ;font-weight: 500 ;letter-spacing: 0px ;">
                                                                            <a href="#">{{$g->descricao}}</a>
                                                                        </h3>
                                                                        <a href="{{url('galeria/'.base64_encode($g->codigo))}}" class="product_type_simple add_to_cart_button ajax_add_to_cart gdlr-core-product-add-to-cart" rel="nofollow">
                                                                            <i class="icon_cart_alt"></i>
